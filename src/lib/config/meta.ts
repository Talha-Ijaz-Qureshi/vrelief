export const siteConfig = {
    ...
    keywords: ["VRelief", "VR Therapy", "Mental Health", "Well-being", "Therapy", "Virtual Reality", "Immersive Experience", "Science-driven Methods", "Compassionate Care", "Mindfulness", "Emotional Support", "Virtual Sessions", "Condition-curated", "Mental Wellness", "Therapeutic VR"],
}
